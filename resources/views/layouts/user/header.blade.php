  	...
  	<div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
	    ...
	    <ul class="navbar-nav">
	    	...
	    	@if(Auth::check())
		      	...
		      	<li class="nav-item">
		        	<a class="nav-link"  href="{{route('user.bookings.index', ['user_id' => Auth::user()->id])}}">{{tr('my_bookings')}}</a>
		      	</li>

		      	<li class="nav-item dropdown">
		        	<a class="nav-link1 dropdown-toggle" id="navbardrop" data-toggle="dropdown">
		        		<img src="{{ Auth::user()->picture ?: asset('placeholder.jpg') }}" class="profile-img" alt="image"/>
		        	</a>
	      	...
	      	@else
		      	...
		      	<li class="nav-item">
		        	<a class="nav-link"  href="{{route('provider.signup_form')}}">{{tr('become_a_host')}}</a>
		      	</li>
